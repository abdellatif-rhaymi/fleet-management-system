...
<div class="card-body">
        ...
        <tbody>
            <c:forEach items="${model.demandes}" var="demande">
                <tr>
                    ...
                    <td>
                        <a href="editerDemandeidVoyage.demande?id=${demande.idDemande}&idV=${idVoyage}" class="btn btn-sm btn-success me-1">Transporter</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
    ...
    <div class="d-flex justify-content-end mt-3">
        <a href="idVehicule.demande?id=${idVoyage}" class="btn btn-primary">Voir les demandes de ce voyage! </a>
    </div>
</div>
