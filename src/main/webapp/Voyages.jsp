            ...
            <tbody>
                <c:forEach items="${model.voyages}" var="v">
                    <tr>
                        ...
                        <td>${v.statut}</td>
                        <td>
                            <a href="editerVehicule.do?id=${v.idVoyage}" class="btn btn-sm btn-warning">Modifier</a>
                            <a href="supprimerVehicule.do?id=${v.idVoyage}" class="btn btn-sm btn-danger">Supprimer</a>
