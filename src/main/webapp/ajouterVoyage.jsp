...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">Nouveau Voyage</h5>
    </div>
    <div class="card-body">
        <div class="container mt-4">
  <form id="voyageForm" action="saveVoyage.voyage" method="post">
    
<div class="mb-3">
      <label for="idVehicule" class="form-label">Sélectionnez une Vehicule</label>
       <select class="form-select" name="idVehicule" id="idVehicule" required>
	       <c:forEach var="vehicule" items="${vehicules}">
	           <option value="${vehicule.idVehicule}">${vehicule.modele}</option>
	       </c:forEach>
	   </select> </div>
    <!-- ID Chauffeur -->
    <div class="mb-3">
      <label for="idChauffeur" class="form-label">Sélectionnez un Chauffeur</label>
       <select class="form-select" name="idChauffeur" id="idChauffeur" required>
	       <c:forEach var="chauffeur" items="${utilisateurs}">
	           <option value="${chauffeur.idUtilisateur}">${chauffeur.nom}</option>
	       </c:forEach>
	   </select> </div>
    <!-- Date Départ -->
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <select class="form-select" id="statut" name="statut" required>
        ...
        <option value="Cancelled">Cancelled</option>
            ...
            <button type="button" id="generate-trajet">Générer Trajet</button>
    <div id="trajet-preview">
        <!-- Carte Leaflet affichera le trajet ici -->
    </div>
