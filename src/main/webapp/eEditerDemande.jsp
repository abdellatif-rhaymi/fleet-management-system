...
<div class="card">
    ...
    <div class="card-body">
    <form action="update.demande" method="post" >
        <!-- Champ cach pour passer l'ID de la demande  modifier -->
        <input type="hidden" name="id_demande" value="${demande.idDemande}" required>

        <div class="mb-3">
            <label for="numero_demande" class="form-label">Numro de Demande</label>
            <input type="text" name="numero_demande" id="numero_demande" value="${demande.numeroDemande}" class="form-control">
        </div>

        <div class="mb-3">
            <label for="date_demande" class="form-label">Date de Demande</label>
            <input type="date" name="date_demande" id="date_demande" value="${demande.dateDemande}" class="form-control" required>
        </div>

        <div class="mb-3">
            <label for="adresse_livraison" class="form-label">Adresse de Livraison</label>
            <input type="text" name="adresse_livraison" id="adresse_livraison" value="${demande.adresseLivraison}" class="form-control" required>
        </div>

        <div class="mb-3">
            <label for="ville" class="form-label">Ville</label>
            <input type="text" name="ville" id="ville" value="${demande.ville}" class="form-control">
        </div>

        <div class="mb-3">
            <label for="code_postal" class="form-label">Code Postal</label>
            <input type="text" name="code_postal" id="code_postal" value="${demande.codePostal}" class="form-control">
        </div>

        <div class="mb-3">
            <label for="pays" class="form-label">Pays</label>
            <input type="text" name="pays" id="pays" value="${demande.pays}" class="form-control">
        </div>

        <div class="mb-3">
            <label for="date_livraison" class="form-label">Date de Livraison</label>
            <input type="date" name="date_livraison" id="date_livraison" value="${demande.dateLivraison}" class="form-control">
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="statut" id="statut" class="form-select" required>
                ...
                <option value="valide" ${demande.statut == 'valide' ? 'selected' : ''}>Valide</option>
                <option value="annule" ${demande.statut == 'annule' ? 'selected' : ''}>Annule</option>
                <option value="complt" ${demande.statut == 'complt' ? 'selected' : ''}>Complt</option>
            </select>
        </div>

        <div class="mb-3">
            <label for="commentaire" class="form-label">Commentaire</label>
            <textarea name="commentaire" id="commentaire" rows="4" class="form-control">${demande.commentaire}</textarea>
        </div>
        <div class="col-md-6">
    <label for="latitude" class="form-label">Latitude</label>
    <input type="text" class="form-control" name="latitude" id="latitude"  value="${demande.latitude}"readonly>
</div>
<div class="col-md-6">
    <label for="longitude" class="form-label">Longitude</label>
    <input type="text" class="form-control" name="longitude" id="longitude" value="${demande.longitude}"readonly>
</div>
        <div class="col-md-6">
            <label for="weight" class="form-label">Poids (kg)</label>
            <input type="number" class="form-control" name="weight" id="weight" value="${demande.weight}">
        </div>
