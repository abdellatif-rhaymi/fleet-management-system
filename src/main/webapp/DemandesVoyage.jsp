...
<div class="card-body">
        ...
        <tbody>
            <c:forEach items="${model.demandes}" var="demande">
                <tr>
                    ...
                    <td>
                        <a href="editerDemandeidVoyage.demande?id=${demande.idDemande}&idV=" class="btn btn-sm btn-danger">X</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
    ...
    <div class="d-flex justify-content-end mt-3">
        <a href="addDV.demande?id=${idVoyage}" class="btn btn-primary">Ajouter autres demandes a ce voyage! </a>
    </div>
</div>
