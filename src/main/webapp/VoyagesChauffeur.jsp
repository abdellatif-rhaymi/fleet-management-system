...
<li class="sidebar-item">
    ...
    <a href="saisie.do" class="btn btn-sm">Ajouter un nouveau véhicule</a>
                <a href="chercher.do" class="btn btn-sm">chercher un véhicule</a>
            ...
            <tbody>
                <c:forEach items="${model.voyages}" var="v">
                    <tr>
                        ...
                        <td>${v.statut}</td>
                        <td>
                            <a href="updateVhiculeVoyageDemandeStatus.do?id=${v.idVoyage}" class="btn btn-sm btn-danger">Commencer le voyage</a>
                            <a href="idVehicule.demande?id=${v.idVoyage}" class="btn btn-sm btn-info">Gerer les coliers</a>
                            <a href="trajet.trajet?id=${v.idVoyage}" class="btn btn-sm btn-success">Generer le trajets</a>
                                                        <a href="Chauffeur.trajet?id=${v.idVoyage}" class="btn btn-sm btn-success">Envoyer ta localisation</a>
