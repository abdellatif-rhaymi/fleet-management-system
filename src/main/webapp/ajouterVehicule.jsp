...
<li class="sidebar-item">
    ...
    <div class="card-header">
        <h5 class="card-title mb-0">Ajouter un vehicule</h5>
    </div>
    <div class="card-body">
        <form action="saveVehicule.do" method="post">
            ...
            <div class="mb-3">
                <label for="derniereMaintenance" class="form-label">Derniere Maintenance</label>
                <input type="date" class="form-control" name="derniereMaintenance" id="derniereMaintenance" required>
            </div>
            <div class="mb-3">
                <label for="capacite" class="form-label">Capacite(Kg)</label>
                <input type="number" class="form-control" name="capacite" id="capacite" required>
            </div>
            <div class="mb-3">
