...
<li class="sidebar-item">
    ...
    <a href="saisie.demande" class="btn btn-sm">Ajouter une nouvelle demande</a>
                <a href="chercher.demande" class="btn btn-sm">chercher une demande</a>
...
<div class="card-body">
        ...
        <tbody>
            <c:forEach items="${model.demandes}" var="demande">
                <tr>
                    ...
                    <td>
                        <a href="editerDemande.demande?id=${demande.idDemande}" class="btn btn-sm btn-warning me-1">Éditer</a>
                        <a href="supprimer.demande?id=${demande.idDemande}" class="btn btn-sm btn-danger">Supprimer</a>
                    </td>
                </tr>
            </c:forEach>
        </tbody>
    ...
    <div class="d-flex justify-content-end mt-3">
        <a href="saisie.demande" class="btn btn-primary">Ajouter une nouvelle demande</a>
    </div>
</div>
