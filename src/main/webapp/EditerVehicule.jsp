...
<li class="sidebar-item">
    ...
    <div class="card-header">
        <h5 class="card-title mb-0">Mettre  jour un vhicule</h5>
    </div>
    <div class="card-body">
        <form action="updateVehicule.do" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="id" id="id" value="${v.idVehicule}">
            </div>
            <!-- Immatriculation -->
            <div class="mb-3">
                <label for="immatriculation" class="form-label">Immatriculation</label>
                <input type="text" class="form-control" name="immatriculation" id="immatriculation" value="${v.immatriculation}" required>
            </div>
            <!-- type -->
            <div class="mb-3">
                <label for="type" class="form-label">Type</label>
                <input type="text" class="form-control" name="type" id="type" value="${v.type}" required>
            </div>
            <!-- Modle -->
            <div class="mb-3">
                <label for="modele" class="form-label">Modle</label>
                <input type="text" class="form-control" name="modele" id="modele" value="${v.modele}" required>
            </div>
            <!-- Couleur -->
            <div class="mb-3">
                <label for="couleur" class="form-label">Couleur</label>
                <input type="text" class="form-control" name="couleur" id="couleur" value="${v.couleur}" required>
            </div>
            <!-- Anne -->
            <div class="mb-3">
                <label for="annee" class="form-label">Anne</label>
                <input type="number" class="form-control" name="annee" id="annee" value="${v.annee}" required>
            </div>
            <!-- Statut -->
            <div class="mb-3">
            ...
            <!-- Dernire maintenance -->
            <div class="mb-3">
                <label for="derniereMaintenance" class="form-label">Dernire Maintenance</label>
                <input type="date" class="form-control" name="derniereMaintenance" id="derniereMaintenance" value="${v.derniereMaintenance}" required>
            </div>
            <!-- Capacit -->
            <div class="mb-3">
                <label for="capacite" class="form-label">Capacit</label>
                <input type="number" class="form-control" name="capacite" id="capacite" value="${v.capacite}" required>
            </div>
            <div class="mb-3">
                <label for="image" class="form-label">Image</label>
                <input type="file" class="form-control" name="image" id="image" value="${v.image}" required>
            </div>
            <!-- Boutons -->
