...
<div class="card">
  ...
  <form method="post" action="inscription.utilisateur" class="register-form" id="register-form">
    <!-- Nom -->
    <div class="mb-3">
      <label for="nom" class="form-label"><i class="zmdi zmdi-account material-icons-name"></i> Nom</label>
      <input type="text" class="form-control" name="nom" id="nom" placeholder="Votre Nom" required />
    </div>

    <!-- Email -->
    <div class="mb-3">
      <label for="email" class="form-label"><i class="zmdi zmdi-email"></i> Email</label>
      <input type="email" class="form-control" name="email" id="email" placeholder="Votre Email" required />
    </div>

    <!-- Mot de passe -->
    <div class="mb-3">
      <label for="motDePasse" class="form-label"><i class="zmdi zmdi-lock"></i> Mot de Passe</label>
      <input type="password" class="form-control" name="motDePasse" id="motDePasse" placeholder="Mot de Passe" required />
    </div>

    <!-- Confirmation du mot de passe -->
    <div class="mb-3">
      <label for="re_pass" class="form-label"><i class="zmdi zmdi-lock-outline"></i> Confirmer Mot de Passe</label>
      <input type="password" class="form-control" name="re_pass" id="re_pass" placeholder="Rpter le Mot de Passe" required />
    </div>

    <!-- Contact -->
    <div class="mb-3">
      <label for="contact" class="form-label"><i class="zmdi zmdi-phone"></i> Contact</label>
      <input type="text" class="form-control" name="contact" id="contact" placeholder="Numro de Contact" required />
    </div>

    <!-- Adresse -->
    <div class="mb-3">
      <label for="adresse" class="form-label"><i class="zmdi zmdi-home"></i> Adresse</label>
      <input type="text" class="form-control" name="adresse" id="adresse" placeholder="Adresse" required />
    </div>

    <!-- Rle -->
    <div class="mb-3">
      <label for="role" class="form-label"><i class="zmdi zmdi-account-circle"></i> Rle</label>
      <select class="form-select" name="role" id="role" required>
        <option value="client">Admin</option>
        <option value="commercant">Gestionnaire de flotte</option>
